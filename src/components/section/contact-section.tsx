...
export default function ContactSection() {
  return (
    <footer className="relative w-full max-w-3xl mx-auto text-center space-y-8 pt-6">
      ...
      {/* Standard Website Footer with Copyright & Owner */}
      <div className="pt-8 border-t border-border/70 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground font-mono">
        <div>
